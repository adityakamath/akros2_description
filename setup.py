...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'meshes', 'akros2_mecanum'), glob('meshes/akros2_mecanum/*.stl')),
        (os.path.join('share', package_name, 'urdf', 'akros2_omni'), glob('urdf/akros2_omni/*.xacro')),
        (os.path.join('share', package_name, 'meshes', 'akros2_omni'), glob('meshes/akros2_omni/*.stl')),
